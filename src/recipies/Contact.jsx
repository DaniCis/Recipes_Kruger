    ...
    return(
        <>
            ...
            <div className="w-full flex items-center justify-center my-8">
                <form className="bg-white shadow rounded-xl border-2 py-8 lg:px-28 px-8">
                    ...
                    <div className="md:flex items-center mt-8">
                        <div className="md:w-72 flex flex-col">
                            ...
                            <input  type="name" className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100"  />
                        </div>
                    ...
                    <div>
                        <div className="w-full flex flex-col mt-8">
                            ...
                            <textarea  type="name" className="h-24 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none"  />
                        </div>
                    </div>
